  ...
  <head>
	...
	$(".xgm").bind("click",function(){
	   ...
	   $(".addmessage").bind("click",function(){
	     ...
	     //历史留言
	   $(".htmessages").bind("click",function(){
// 	  	 alert("进来了");
...
// 			    alert("11"); 
  ...
  <body>
     ...
     <div id="top"> 
          ...
          <div id="status">
              <span style="color:black"><%=sname %></span><span>您好，欢迎登录</span>&nbsp&nbsp<a href="login.jsp">退出</a>
          </div>    
      </div>
      <div id="center">
          <div id="left">
             <table>
              ...
              <td><a href="javascript:void(0);" class="addmessage" style="font-size:20px;">我要留言</a></td></tr>
              <tr><td><a href="javascript:void(0);" class="htmessages" style="font-size:20px;">历史留言</a></td></tr>
